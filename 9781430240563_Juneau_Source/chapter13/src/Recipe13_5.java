 ...
 * Date: 9/29/11
 * Time: 9:20 PM
 * Recipe to navigate universe
 *
 */
public class Recipe13_5 {
    private SimpleUniverse universe ;
    private static final int NUMBER_OF_ASTEROIDS = 500;
    Random random = new Random();

    public static void main(String[] args) {
        Recipe13_5 recipe = new Recipe13_5();
        recipe.start();
    }
    ...
    private BranchGroup createScene() {
        ...
        KeyNavigatorBehavior keyNavigatorBehavior = new KeyNavigatorBehavior(universe.getViewingPlatform().getViewPlatformTransform());
        ...
        topGroup.addChild(transformGroup);
        topGroup.addChild(mouseRotate);
        topGroup.compile();
        return topGroup;
    }
