package org.java7recipes.chapter17.recipe17_03;
 ...
 * @author cdea
 */
public class MediaActionsAndEvents extends Application {
    ...
    public void start(final Stage primaryStage) {
        primaryStage.setTitle("Chapter 17-3 Media Actions and Events");
        ...
        scene.setOnDragDropped(new EventHandler<DragEvent>() {
            ...
            public void handle(DragEvent event) {
                ...
                mediaPlayer.setOnPaused(new Runnable() {
                    @Override
                    public void run() {
                        pauseMessage.setText("Paused \nDuration: " + mediaPlayer.currentTimeProperty().getValue().toMillis());
    ...
    private Text createPauseMessage(String message) {
